...
def compute_avg_and_stdev_for_task(task: str, task_metrics: dict, use_latency: bool):
    ...
    average_metric_50, average_metric_90, average_error_rates = compute_geometric_means(cumulative_metric_50, cumulative_metric_90, cumulative_error_rates)
...
def compute_geometric_means(cumulative_metric_50, cumulative_metric_90, cumulative_error_rates):
    average_task_metric_50 = statistics.geometric_mean(cumulative_metric_50)
    average_task_metric_90 = statistics.geometric_mean(cumulative_metric_90)
    average_task_error_rates = statistics.mean(cumulative_error_rates)
